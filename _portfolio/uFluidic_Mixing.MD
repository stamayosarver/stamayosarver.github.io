...
![B pattern i1](/assets/img/Herringbone_mixer_proof_of_mixing.pdf)

![B pattern i2](/assets/img/Image_Pattern_B_Overallparameters.pdf)

![B pattern i3](/assets/img/How_SHM_works.pdf)
