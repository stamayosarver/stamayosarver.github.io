...
There are primarily two types of mixing in microfluidics — Active and Passive mixing. Active mixing includes various ways to create flow through vibration, heat, or magnetism. However, as this device entails only passive mixing, only passive mixing techniques will be described. Passive mixing techniques are all about utilizing geometric features within the microchannels. There are many different types of geometric patterns, all tested for efficacy. The best categories based off data from the last five years is illustrated in the table below:
